...
\chapter{Доказательство теоремы о равносильности \_ и \_} 

\begin{theorem}\label{theorem1} $\mathcal{T}_C$ и $\mathcal{T}_A$ --- конкретная и абстрактная транзакционная память соответственно, тогда :
...
$TMS$ отношение необходимо и достаточно для уточнения абстрактной транзакционной памяти конкретной транзакционной памятью, что и требовалось доказать.                 
\end{mproof}
% переписать для всей теоремы 
% \begin{mproof}
